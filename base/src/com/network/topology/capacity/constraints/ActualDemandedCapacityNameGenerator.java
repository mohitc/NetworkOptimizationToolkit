...
public class ActualDemandedCapacityNameGenerator extends LPNameGeneratorImpl<String> {

	private static final String PREFIX = "DEMANDEDCAPACITY";

	private static final Logger log = LoggerFactory.getLogger(ActualDemandedCapacityNameGenerator.class);

	private Set<String> vertexVars;

	public ActualDemandedCapacityNameGenerator(String prefix, int indexCount) {
		super(PREFIX, 2);
	    if (vertexVars!=null) {
