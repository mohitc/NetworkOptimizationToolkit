...
public class FixedTopologyModel {
  ...
  public void initConstraintGroups() throws LPConstraintGroupException {
    ...
    try {
      ...
      DynCircuitBountConstrGroupInitializer dynCircuitBountConstrGroupInitializer = new DynCircuitBountConstrGroupInitializer(vertexLabels, factory.getDynamicCircuitNameGenerator(circuitClasses));
