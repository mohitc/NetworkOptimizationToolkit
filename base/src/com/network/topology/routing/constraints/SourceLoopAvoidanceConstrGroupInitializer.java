...
public class SourceLoopAvoidanceConstrGroupInitializer extends LPMLGroupInitializer {

  private static final Logger log = LoggerFactory.getLogger(SourceLoopAvoidanceConstrGroupInitializer.class);

  public SourceLoopAvoidanceConstrGroupInitializer(Set<String> vertexVars) {
    super(vertexVars);
  }
