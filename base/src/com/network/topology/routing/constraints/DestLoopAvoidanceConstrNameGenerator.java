...
public class DestLoopAvoidanceConstrNameGenerator extends LPNameGeneratorImpl<String> {

  private static final String DEST_LOOP_AVOIDANCE_CONST_PREFIX = ConstraintPrefixes.LOOP_AVOIDANCE_DESTINATION;

  private static final String LOG_PREFIX = "DEST_LOOP_AVOIDANCE:- ";

  private static final Logger log = LoggerFactory.getLogger(DestLoopAvoidanceConstrNameGenerator.class);

  public DestLoopAvoidanceConstrNameGenerator(Set<String> vertexVars) {
    super(DEST_LOOP_AVOIDANCE_CONST_PREFIX, 2);
    if (vertexVars == null) {
