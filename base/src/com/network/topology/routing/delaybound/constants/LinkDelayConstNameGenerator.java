...
public class LinkDelayConstNameGenerator extends LPNameGeneratorImpl<String> {
  private static final String PREFIX = ConstantPrefixes.LINK_DELAY;

  private static final Logger log = LoggerFactory.getLogger(LinkDelayConstNameGenerator.class);

  public LinkDelayConstNameGenerator(Set<String> vertexVars) {
    super(PREFIX, 2);
    if (vertexVars==null) {
