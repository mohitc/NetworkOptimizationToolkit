...
public class ServiceAwareSourceLoopAvoidanceConstrGroupInitializer extends LPMLGroupInitializer {

  private static final Logger log = LoggerFactory.getLogger(ServiceAwareSourceLoopAvoidanceConstrGroupInitializer.class);

  public ServiceAwareSourceLoopAvoidanceConstrGroupInitializer(Set<String> vertexVars) {
    super(vertexVars);
  }
        ...
        for (String s : vertices) {
          for (String d : vertices) {
            ...
            for (String i : vertices) {
              if (i.equals(s))
                continue;
              lhs.addTerm(model().getLPVar(serviceRoutingNameGenerator.getName(n, s, d, i, s)));
            }
