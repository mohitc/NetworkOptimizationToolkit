...
public class ServiceAwareDestLoopAvoidanceConstrNameGenerator extends LPNameGeneratorImpl {

  private static final String DEST_LOOP_AVOIDANCE_CONST_PREFIX = ServiceAwareConstraintPrefixes.SERVICE_LOOP_AVOIDANCE_DEST;

  private static final String LOG_PREFIX = "SERVICE_DEST_LOOP_AVOIDANCE:- ";

  private static final Logger log = LoggerFactory.getLogger(ServiceAwareDestLoopAvoidanceConstrNameGenerator.class);

  public ServiceAwareDestLoopAvoidanceConstrNameGenerator(Set<String> vertexVars, int serviceClasses) {
    super(DEST_LOOP_AVOIDANCE_CONST_PREFIX, 3);
    if (vertexVars == null) {
