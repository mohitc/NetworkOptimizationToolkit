...
public class ServiceAwareSymmetricRoutingConstrGroupInitializer extends LPMLGroupInitializer {

  private static final Logger log = LoggerFactory.getLogger(ServiceAwareSymmetricRoutingConstrGroupInitializer.class);

  public ServiceAwareSymmetricRoutingConstrGroupInitializer(Set<String> vertexVars) {
    super(vertexVars);
  }
