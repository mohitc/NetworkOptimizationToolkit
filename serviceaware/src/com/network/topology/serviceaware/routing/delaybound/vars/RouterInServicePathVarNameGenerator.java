...
public class RouterInServicePathVarNameGenerator extends LPNameGeneratorImpl {

  private static final String PREFIX = ServiceAwareVariablePrefixes.ROUTER_SERVICE_PATH;

  private static final Logger log = LoggerFactory.getLogger(RouterInServicePathVarNameGenerator.class);

  public RouterInServicePathVarNameGenerator(Set<String> vertexVars, int serviceClasses) {
    super(PREFIX, 4);
    if (vertexVars==null) {
